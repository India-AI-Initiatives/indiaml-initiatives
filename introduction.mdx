...
India AI Initiatives is a community-led effort to accelerate practical progress in foundational AI tech by building, sharing, and applying open resources.

## Mission

- **Core thought:** Build something real in foundational AI technologies(models, frameworks, infra), keeping it 100% open (MIT) so anyone can use, learn from, and build on it.
